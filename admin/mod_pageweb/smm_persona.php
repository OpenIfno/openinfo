<?php
	...
	$id_mod_estado = cls_sistema::get_id_alias("STA_SMM_PERSONA");
  $id_mod_eliminar = cls_sistema::get_id_alias("DEL_SMM_PERSONA");
...
<div class="user-data m-b-30" style="width:100%;">
    ...
    <div class="filters m-b-45">
        <div class="pull-right" style="margin-bottom:5%;" >
			<?php
        $id_persona=$_GET["id"];
        echo "<a href='../page/index.php?m=".$id_mod_agregar."&p=".$id_persona."' class='heading mantto_exg'><i class='fa fa-plus-circle'></i> ".cls_sistema::get_nombre_aplicacion($id_mod_agregar)."</a>";
      ?>
		</div>
        <?php
            $query = "SELECT * FROM team_smm WHERE id_persona='".$id_persona."'";
            ...
            if($total>0){
                ...
                while($datos = $_oControl->obtener_cursor($rs)){
                    ...
                    $nombre = $datos["nombre"];
                    $estado = $datos["estado"];
                    $btn_editar = "<a href='../page/index.php?m=".$id_mod_editar."&p=".$id_persona."&id=".$id."' class='btn btn-info tooltip_exg' title='Editar registro' data-placement='bottom'><i class='fa fa-edit'></i></a>";

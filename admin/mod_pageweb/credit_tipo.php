<?php
	...
	$id_mod_listar = cls_sistema::get_id_alias("TIP_COLECCION");
    ...
    <div class="card-header">
      <?php echo $nombre_aplicacion; ?>
		...
		<div class="card-body card-block">
          ...
          <div class="col col-md-3 col-md-offset-1">
						<div class="pull-right">
            <label for="titulo" class=" form-control-label">Filtro:</label>
						</div>
					</div>
          <div class="col-12 col-md-5">
            <input type="text" id="nombre" name="filtro" value="<?php if($task=="edit"){echo $reg_filtro;} ?>" class="form-control">
          </div>
				</div>
				<div class="row form-group">
          <div class="col col-md-3 col-md-offset-1">

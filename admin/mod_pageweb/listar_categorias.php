<?php
    ...
    $id_mod_noticia = cls_sistema::get_id_alias("NEWS");
  	...
  	$id_mod_estado = cls_sistema::get_id_alias("STA_CAT");
    $id_mod_eliminar = cls_sistema::get_id_alias("DEL_CAT");
...
<div class="user-data m-b-30" style="width:100%;">
    ...
    <div class="filters m-b-45">
        <div class="pull-right" style="margin-bottom:5%;" >
			<?php
      echo "<a style='padding-right: 15px;' href='../page/index.php?m=".$id_mod_noticia."' class=''><i class='fa fa-arrow-circle-left'></i> ".cls_sistema::get_nombre_aplicacion($id_mod_noticia)."</a>";

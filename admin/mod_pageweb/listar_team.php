<?php
	...
	$id_mod_estado = cls_sistema::get_id_alias("STA_PERSONA");
  $id_mod_eliminar = cls_sistema::get_id_alias("DEL_PERSONA");
  $id_mod_smm = cls_sistema::get_id_alias("SMM_PERSONA");
        ...
        <?php
            ...
            if($total>0){
                ...
                while($datos = $_oControl->obtener_cursor($rs)){
                    ...
                    $btn_smm = "<a href='../page/index.php?m=".$id_mod_smm."&id=".$id."' class='btn btn-success' title='Redes Sociales' data-placement='bottom'><i class='fab fa-telegram-plane'></i></a>";
                    ...
                    $table .= " <tr>
                                    ...
                                    <td class='text-center actions'><div class='btn-group btn-group-xs'>".$btn_editar.$btn_delete.$btn_smm."</div></td>
                                </tr>";
                    $aux++;
                }
            }

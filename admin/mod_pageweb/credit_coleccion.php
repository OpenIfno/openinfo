<?php
	...
	$id_mod_listar = cls_sistema::get_id_alias("GALLERY");
	...
	if(trim($task)=="new" || trim($task)=="edit"){
      ...
      // }
			...
			$id_imagen = fncSeguridad($_GET["id"]);
			if(fncVerificarID($id_imagen)==1){
				$title = "Editar Noticia";
				$_oControl = cls_control::get_instancia();
				$consulta = "SELECT * FROM gallery WHERE id_image='".$id_imagen."'";
    ...
    <div class="card-header">
      <?php echo $nombre_aplicacion; ?>
    	...
    	?>
          ...
          <div class="col-12 col-md-5">
            <input type="text" id="titulo" name="nombre" value="<?php if($task=="edit"){echo $reg_nombre;} ?>" class="form-control">
          </div>
				</div>
				<div class="row form-group">
          <div class="col col-md-3 col-md-offset-1">
						<div class="pull-right">
            <label for="tipo" class=" form-control-label">Categoria:</label>
						</div>
					</div>
          <div class="col-12 col-md-5">
